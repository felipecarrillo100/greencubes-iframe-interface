...
export interface WFSModelOptions extends WFSFeatureStoreCreateOptions {
    url: string;
    featureTypeName: string;
}

export interface OGC3DModelOptions extends CreateOGC3DTilesModelOptions {
    url: string;
}

export interface HSPCModelOptions extends CreateHSPCTilesModelOptions {
    url: string;
}

export interface WMSTileSetModelOptions extends WMSTileSetModelConstructorOptions {
    crs?: string;
}

export interface AzureMapsModelOptions extends Omit<AzureMapsTileSetModelCreateOptions, "subscriptionKey"> {
    subscriptionKey?: string;
}

/**
 * Specific options for our GeoJSON Model Factory
 */
